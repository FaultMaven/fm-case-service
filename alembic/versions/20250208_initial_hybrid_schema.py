...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # JSONB columns for low-cardinality flexible data
        # PostgreSQL: native JSONB, SQLite: TEXT with JSON validation
        sa.Column('consulting', postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default='{"initial_description": "", "context": {}, "user_goals": []}'),
        sa.Column('problem_verification', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('working_conclusion', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('root_cause_conclusion', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('path_selection', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('degraded_mode', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('escalation_state', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('documentation', postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default='{"summary": "", "timeline": [], "lessons_learned": []}'),
        sa.Column('progress', postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default='{"current_phase": "consulting", "completion_percentage": 0, "milestones": []}'),
